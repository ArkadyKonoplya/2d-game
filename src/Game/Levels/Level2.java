/*
 * LEVEL 2
 * This is the level 2 of our game. The play has only 50 seconds to catch all the gems. 
 * 
 * */
package Game.Levels;
...
public class Level2 extends JFrame implements ActionListener {
	...
	int totalTime =50000;// Total time to find all the gems
...
*/
		...
		public void actionPerformed(ActionEvent e) {
			...
			//The player has completed finding all the gems
			...
			//The time elapsed before the player could find all the gems
			if(totalTime==0)
			{
				timer.stop();
				this.dispose();
